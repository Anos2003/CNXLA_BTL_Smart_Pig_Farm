...
<img width="100%" src="[https://github.com/user-attachments/assets/placeholder_demo1.png](https://github.com/user-attachments/assets/placeholder_demo1.png)"><img width="100%" src="[https://github.com/user-attachments/assets/placeholder_demo2.png](https://github.com/user-attachments/assets/placeholder_demo2.png)">

*(Lưu ý: Bạn hãy upload ảnh chụp màn hình Dashboard của bạn lên GitHub và thay thế link vào đoạn trên nhé)*
...
| Nhiệt độ < Ngưỡng (VD: 20°C) VÀ Phát hiện lợn tụ tập | ❄️ Báo động tập tính (Tụ tập do lạnh) | Tự động BẬT Đèn sưởi |
